...
public class CorCashTransferBank implements Serializable {
    private Date AlloDate;
    private int RefNo;
    private Date ExecDate;
    private int FromSubAccoCd;
    private String ToBankAccoNo;
    private String ToBankAccoName;
    private String ToBankCd;
    private String ToBankBranchName;
    ...
    public String getToBankAccoNo() {
        return ToBankAccoNo;
    }

    public void setToBankAccoNo(String toBankAccoNo) {
        ToBankAccoNo = toBankAccoNo;
    }

    public String getToBankAccoName() {
        return ToBankAccoName;
    }

    public void setToBankAccoName(String toBankAccoName) {
        ToBankAccoName = toBankAccoName;
    }

    public String getToBankCd() {
        return ToBankCd;
    }

    public void setToBankCd(String toBankCd) {
        ToBankCd = toBankCd;
    }

    public String getToBankBranchName() {
        return ToBankBranchName;
    }

    public void setToBankBranchName(String toBankBranchName) {
        ToBankBranchName = toBankBranchName;
    }
